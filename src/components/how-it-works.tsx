  ...
  return (
    <section id="how-it-works" className="py-32 px-6">
      <div className="mx-auto max-w-6xl">
        ...
        >
          <span className="text-white/90">One message to start.</span>
          <br />
          <span className="text-white/35">A memory that never ends.</span>
        </h2>

        {/* Steps */}
        <div className="grid gap-px bg-white/5 sm:grid-cols-3">
          {STEPS.map(({ step, title, description }) => (
            <div key={step} className="bg-[#030712] p-8 hover:bg-white/[0.02] transition-colors">
